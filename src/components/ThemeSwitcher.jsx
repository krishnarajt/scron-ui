  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-surface-3"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute bottom-full left-0 mb-2 w-56 p-2 rounded-xl border shadow-2xl z-50"
            style={{
          ...
          >
            ...
            {THEMES.map((t) => (
              ...
              >
                {/* Accent color dot */}
                <div
                  className="w-4 h-4 rounded-full flex-shrink-0 ring-2 ring-offset-1 transition-all duration-200"
                  style={{
                    background: t.accent,
