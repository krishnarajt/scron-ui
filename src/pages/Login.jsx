...
import { Terminal, ArrowRight, Loader2, Lock } from 'lucide-react';
    ...
    <div className="noise-bg min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="text-sm mb-8" style={{ color: 'var(--txt-muted)' }}>Sign in to your account</p>
        ...
        >
          ...
          <Link to="/signup" className="font-semibold transition-colors duration-200"
